# sample -> snapshot statici + traiettorie finali + slider interattivo su TensorBoard
import torch
...
# ======================
# FUNZIONE PER CONVERTIRE FIGURA IN IMMAGINE
# ======================
...
# ======================
# SNAPSHOT STATICI STEP 10,20,30,40,50 (invariati)
# ======================
...
# ======================
# TRAIETTORIE COMPLETE CON SLIDER INTERATTIVO
# ======================
for step_idx, traj in enumerate(trajectories):
    ...
    # Punti trasformati al passo corrente (rosso)
    ...
    ax.grid(True, alpha=0.2)
    ax.legend()
    # Salvataggio step-by-step per simulare barra interattiva su TensorBoard
    writer.add_image("RectifiedFlow/Trajectories", plot_to_image(fig), global_step=step_idx)
    plt.close(fig)

writer.close()
print("Sampling completo. Snapshots statici e traiettorie con slider salvati su TensorBoard!")